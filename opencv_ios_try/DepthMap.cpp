...
{
    for (int i=3;i<height-3;i=i+10){
        observeDepthRow(i,i+10);
    }
}
...
bool DepthMap::observeDepthCreate(const int &x, const int &y, const int &idx)
{
    ...
    Frame* refFrame = oldest_referenceFrame;
...
void DepthMap::regularizeDepthMapFillHoles()
{
    ...
    for (int i=3;i<height-2;i=i+10){
        regularizeDepthMapFillHolesRow(i,i+10);
    }
}
