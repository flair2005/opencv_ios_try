...
//
template class Sophus::SE3Group<float, Eigen::DontAlign>;
template class Sophus::SE3Group<double, Eigen::DontAlign>;

template class Sophus::Sim3Group<float, Eigen::DontAlign>;
template class Sophus::Sim3Group<double, Eigen::DontAlign>;
