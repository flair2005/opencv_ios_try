...
extern template class Sophus::SE3Group<float, Eigen::DontAlign>;
extern template class Sophus::SE3Group<double, Eigen::DontAlign>;

extern template class Sophus::Sim3Group<float, Eigen::DontAlign>;
extern template class Sophus::Sim3Group<double, Eigen::DontAlign>;
